...
This repository's own code is **MIT-licensed** (`LICENSE.txt`) and vendors **no
GPL *source***. The upstream `main.py` is **GPL-2.0** and is **not included
here**, so this GPL script contributes no GPL content to the source tree or the
releases. If you fetch
